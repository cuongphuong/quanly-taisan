...
public interface ThietBiRepositoryByManhGa extends ThietBiRepository {
	...
	@Query(value = "select ThietBi.* from ThietBi inner join LoaiTB on (ThietBi.MaLoai = LoaiTB.MaLoai) where LoaiTB.MaLoaiCha in (select MaLoai from LoaiTB where MaLoaiCha is null and MaNCC = :MaNCC) and LoaiTB.MaLoaiCha = :MaLoai", nativeQuery = true)
